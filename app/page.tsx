...
import { ArrowDown, ArrowUp, Crown, Medal, RefreshCw, Search, Trophy, Users, Zap, BarChart3, Sparkles, X, ChevronDown, ChevronUp } from 'lucide-react';
...
export default function Home(){
 ...
 return <main>
  <section className="hero"><div className="hero-orb orb-one"/><div className="hero-orb orb-two"/><div className="container hero-inner">
   <div className="hero-top"><div className="brand-pill"><Trophy size={15}/> FANTASY PREMIER LEAGUE</div><div className="id-pill">LEAGUE ID <b>136557</b></div></div>
   <div className="hero-copy"><div className="eyebrow">2026 / 27 • CLASSIC LEAGUE • V5.5.2</div><h1>4G LTE <span>SUPER</span> LEAGUE</h1><p>Command center untuk memantau klasemen, momentum ranking, performa Gameweek, dan manager terbaik dalam satu dashboard.</p></div>
  ...
  <div className="container page-shell">
   ...
   <footer>4G LTE SUPER LEAGUE • FPL Dashboard • League ID 136557 • Data from Fantasy Premier League</footer>
  </div>
 </main>
}
